  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        // In SelectItem, change the className:
        className={cn(
          "relative flex w-full cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3 text-sm font-medium text-gray-900 outline-hidden select-none focus:bg-amber-50 focus:text-gray-900 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
          className,
        )}
        position={position}
        align={align}
