  ...
  return (
    <div className="flex h-full flex-col rounded-3xl bg-[#1A1A1A] p-5 sm:p-7 dark:bg-card">
      ...
      <Link
        ...
        className="group relative block h-72 w-full flex-1 overflow-hidden rounded-2xl bg-[#3a3733] sm:h-80"
      >
        {hero.firstImageUrl ? (
          <Image
      ...
      <div className="mt-6 flex justify-center">
        <Link
          href={viewAllHref}
          className="rounded-full border border-[#6b6862] px-5 py-2.5 text-xs font-medium text-[#e8e6e1] transition hover:bg-white/10 sm:text-sm"
        >
          {ctaLabel}
        </Link>
      </div>
