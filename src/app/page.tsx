  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-10">
        {/* ---------- Hero: fills the viewport below the nav ---------- */}
        <section className="flex min-h-screen flex-col justify-center pt-20 sm:pt-24">
          <div className="grid grid-cols-1 items-start gap-10 text-center lg:grid-cols-[1.1fr_0.9fr] lg:gap-16 lg:text-left">
            <div className="flex flex-col items-center lg:items-start">
              ...
              <p className="mt-5 max-w-lg text-base leading-relaxed text-muted-foreground sm:text-lg">
                ...
                unforgettable wedding moments — buy, rent, or design something
                entirely your own.
              </p>
        ...
        {/* ---------- Bridal collection: fills its own viewport ---------- */}
        <section className="flex min-h-screen flex-col justify-center py-10">
          <BridalCarousel />
        </section>

        {/* ---------- Rent + Accessories: fills its own viewport ---------- */}
        ...
        {/* ---------- Custom design process: fills its own viewport ---------- */}
        <section className="flex min-h-screen flex-col justify-center py-10">
          <CustomDesignProcess />
        </section>
      </main>
